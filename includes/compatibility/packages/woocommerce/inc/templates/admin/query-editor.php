...
<div class="jet-engine-edit-page__fields">
	...
	<div class="cx-vui-panel">
		...
		>
			...
			<cx-vui-tabs-panel
				name="product"
				label="<?php _e( 'Product', 'jet-engine' ); ?>"
				key="product"
			>
				<cx-vui-input
			...
			<cx-vui-tabs-panel
				name="prices"
				label="<?php _e( 'Prices', 'jet-engine' ); ?>"
				key="prices"
			>
				<cx-vui-input
			...
			<cx-vui-tabs-panel
				name="measurements"
				label="<?php _e( 'Measurements', 'jet-engine' ); ?>"
				key="measurements"
			>
				<cx-vui-input
			...
			<cx-vui-tabs-panel
				name="specific"
				label="<?php _e( 'Specific', 'jet-engine' ); ?>"
				key="specific"
			>
