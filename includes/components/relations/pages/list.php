...
if ( ! class_exists( 'Jet_Engine_Relations_Page_List' ) ) {
	...
	class Jet_Engine_Relations_Page_List extends Jet_Engine_CPT_Page_Base {
		...
		public function get_name() {
			return esc_html__( 'Posts Relations List', 'jet-engine' );
		}
		...
		public function page_specific_assets() {
			...
			wp_enqueue_script(
				'jet-engine-cpt-list',
				jet_engine()->plugin_url( 'assets/js/admin/relations/list.js' ),
		...
		public function add_page_template() {
			...
			ob_start();
			include jet_engine()->get_template( 'admin/pages/relations/list.php' );
