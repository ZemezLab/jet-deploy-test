		...
		>
			...
			<div class="cx-vui-panel" slot="content">
				...
				<cx-vui-select
					...
					:size="'fullwidth'"
					:multiple="false"
					v-model="generalSettings.post_type_1"
				></cx-vui-select>
				<cx-vui-select
					...
					:size="'fullwidth'"
					:multiple="false"
					v-model="generalSettings.post_type_2"
				></cx-vui-select>
				<cx-vui-select
				...
				<cx-vui-select
					...
					:size="'fullwidth'"
					:multiple="false"
					v-model="generalSettings.parent_relation"
				></cx-vui-select>
			</div>
		</cx-vui-collapse>
		<cx-vui-collapse
		...
		>
			...
			<div class="cx-vui-panel" slot="content">
				<cx-vui-switcher
					...
					:wrapper-css="[ 'equalwidth' ]"
					v-model="advancedSettings.post_type_1_control"
				></cx-vui-switcher>
				<cx-vui-switcher
					...
					:wrapper-css="[ 'equalwidth' ]"
					v-model="advancedSettings.post_type_2_control"
				></cx-vui-switcher>
			</div>
		</cx-vui-collapse>
	</div>
